...
my_html_file <- 'tabs/tab09_SOFIX_2007-2024.html' # where to save html file?
...
estimate_garch <- function(ar_lag,
  ...
  my_garch_2007_2024<- ugarchfit(spec = my_spec, data = df_prices$log_ret)
  
  return(my_garch_2007_2024)
}
